...
export const countryInfoByAreaCode = (phoneNumber: string): ICountryInfoRow | null => {
...
export const countriesInfo: ICountryInfoRow[] = [
  ...
  },
  {
    ...
    phoneMask: '\\d\\d\\d-\\d\\d\\d-\\d\\d\\d\\d',
    sortOrder: 2,
    areaCodes: [204, 226, 236, 249, 250, 289, 306, 343, 365, 367, 403, 416, 418, 431, 437, 438, 450, 506, 514, 519, 548, 579, 581, 587, 604, 613, 639, 647, 705, 709, 778, 780, 782, 807, 819, 825, 867, 873, 902, 905]
  },
  {
